    ...
    <aside className="w-64 bg-sidebar border-r border-sidebar-border min-h-screen flex flex-col">
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        ...
        {!isRestrictedAdmin && (<>
          ...
          <NavLink to="/admin/real-time-questions" className={({ isActive }) => cn("flex items-center gap-3 px-3 py-2.5 rounded-md transition-all text-sm font-medium", isActive ? "bg-sidebar-accent text-sidebar-accent-foreground" : "text-sidebar-foreground hover:bg-sidebar-accent/50")}><Activity className="h-4 w-4" /><span>Real Time Questions</span></NavLink>
