...
// V4 uses its own proxy → http://204.12.237.78:5006 (per user spec)
export const V4_PROXY_BASE = `${SUPABASE_URL}/functions/v1/v4-player-proxy`;
export const V4_CDN_BASE = 'https://server1.simplelecture.com/video';

export const SPEED_STEPS = [0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.5, 3];
